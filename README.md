...
Analizamos Goocle cloud Platfotrm, este no cuenta con costo en prueba gratuita, pero si existe un tipo "lite", ya que en este caso se pueden crear varios recursos, pero hay un límite, luego de pasar ese límite se crean los recursos, pero no funcionan, aunque usted puede envíar un correo al soporte para así poder obtener más de manera gratuita, simplemente dando una breve explicación de a que se debe dicha solicitud, este proveedor brinda un buena experiencia de usuario y una interfaz amigable, no causó ningúun problema, además en tema de tutorial fue muy básico, pero suficiente para tener una idea de como implementar una aplicación sencilla.
...
[6] Microsoft Azure (S.F). ¿Qué es una nube pública?. [Online] Disponible: https://azure.microsoft.com/es-es/overview/what-is-a-public-cloud/

[7] Cabacas,T.(2018,Julio 12). ¿Qué es la nube híbrida y por qué no paras de oír hablar de ella?. [Online]. Disponible: https://www.muycomputerpro.com/2018/07/12/que-es-nube-hibrida

[8] Mirosoft Azure.(S.F) ¿Qué es la nube pública, privada e híbrida?. [Online]. Disponible: https://azure.microsoft.com/es-es/overview/what-are-private-public-hybrid-clouds/

[9] Microsoft Azure. (S.F) ¿Qué es IaaS? Infraestructura como servicio. [Online] Disponible: https://azure.microsoft.com/es-es/overview/what-is-iaas/
